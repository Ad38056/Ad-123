...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} MyCalendar 
   Caption         =   "Calendar By TheDataLabs"
   ClientHeight    =   3936
   ClientLeft      =   120
   ClientTop       =   456
   ClientWidth     =   5400
...
'##############################################################
'## Developed by - TheDataLabs                              ###
'## Date: 27th Dec 2019                                     ###
'## Please visit www.thedatalabs.org                        ###
'## Contact us at info@thedatalabs.org                      ###
'##############################################################
...
Private Sub Add_Year()
    ...
    iCurrentYear = Val(Format(Date, "YYYY")) - 60
    
    Me.cmbYear.Clear
    
    For i = iCurrentYear To (iCurrentYear + 100)
...
Private Sub D1_Click()
    ...
    Me.txtDay.Value = DateSerial(iYear, iMonth, iDay)
